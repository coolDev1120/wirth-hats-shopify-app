...
declare type CmdSensitiveFieldsFromMonorail = PickByPrefix<monorail.MonorailEventSensitive, 'app_'> & PickByPrefix<monorail.MonorailEventSensitive, 'cmd_dev_'>;
declare const metadata: metadataLib.RuntimeMetadataManager<{
    project_type: string;
    partner_id: number;
    api_key: string;
