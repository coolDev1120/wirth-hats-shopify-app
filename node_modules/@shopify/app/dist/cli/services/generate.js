...
function validateExtensionFlavor(specification, flavor) {
    ...
    if (!possibleFlavors.includes(flavor)) {
        throw new error.Abort('Invalid template for extension type', `Expected template to be one of the following: ${possibleFlavors.join(', ')}.`);
    }
}
