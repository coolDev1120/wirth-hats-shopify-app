...
export declare const AppConfigurationSchema: schema.define.ZodObject<{
    ...
    webDirectories: schema.define.ZodOptional<schema.define.ZodArray<schema.define.ZodString, "many">>;
...
export declare const WebConfigurationSchema: schema.define.ZodObject<{
    ...
    authCallbackPath: schema.define.ZodOptional<schema.define.ZodUnion<[schema.define.ZodEffects<schema.define.ZodString, string, string>, schema.define.ZodArray<schema.define.ZodEffects<schema.define.ZodString, string, string>, "many">]>>;
