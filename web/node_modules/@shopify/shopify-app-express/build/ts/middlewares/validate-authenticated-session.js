...
function validateAuthenticatedSession(_a) {
    ...
    return function validateAuthenticatedSession() {
        ...
        return function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var sessionId, error_1, session, error_2, shop, redirectUrl;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 10:
                        ...
                        return [2 /*return*/, undefined];
                    case 11:
                        shop = req.query.shop || (session === null || session === void 0 ? void 0 : session.shop);
                        ...
                        config.logger.debug('Request session found and loaded', {
                            shop: session === null || session === void 0 ? void 0 : session.shop,
                        });
                        if (!(session === null || session === void 0 ? void 0 : session.isActive(api.config.scopes))) return [3 /*break*/, 13];
                    ...
                    case 13:
                        ...
                        return [2 /*return*/, (0, return_top_level_redirection_1.returnTopLevelRedirection)({
                                res: res,
                                config: config,
                                bearerPresent: Boolean((_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.match(/Bearer (.*)/)),
