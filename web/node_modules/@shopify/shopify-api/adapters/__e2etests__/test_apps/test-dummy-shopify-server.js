...
var test_config_types_1 = require("../test_config_types");
var utils_1 = require("../utils");
// eslint-disable-next-line no-process-env
var port = parseInt(process.env.HTTP_SERVER_PORT || '3000', 10);
var errorStatusText = 'Did not work';
var requestId = 'Request id header';
var tests = {
    200: {
...
var server = (0, http_1.createServer)(function (req, res) {
    var _a;
    var lookup = (_a = req.url) === null || _a === void 0 ? void 0 : _a.match(/^\/url\/path\/([a-z0-9]*)$/);
    var receivedHeaders = req.headers;
    var code = lookup ? lookup[1] : '200';
    var test = tests[code] || tests['200'];
    var expectedRequest = test.expectedRequest;
    var testResponse = test.testResponse;
