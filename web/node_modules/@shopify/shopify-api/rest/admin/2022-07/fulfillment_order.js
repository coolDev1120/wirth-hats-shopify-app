...
var FulfillmentOrder = /** @class */ (function (_super) {
    ...
    FulfillmentOrder.prototype.move = function (_a) {
        var _b = _a.fulfillment_order, fulfillment_order = _b === void 0 ? null : _b, _c = _a.body, body = _c === void 0 ? null : _c, otherArgs = tslib_1.__rest(_a, ["fulfillment_order", "body"]);
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.request({
                            ...
                            session: this.session,
                            urlIds: { "id": this.id },
                            params: tslib_1.__assign({ "fulfillment_order": fulfillment_order }, otherArgs),
                            body: body,
                            entity: this,
                        })];
                    case 1:
