...
var Fulfillment = /** @class */ (function (_super) {
    ...
    Fulfillment.prototype.update_tracking = function (_a) {
        var _b = _a.notify_customer, notify_customer = _b === void 0 ? null : _b, _c = _a.tracking_info, tracking_info = _c === void 0 ? null : _c, _d = _a.body, body = _d === void 0 ? null : _d, otherArgs = tslib_1.__rest(_a, ["notify_customer", "tracking_info", "body"]);
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, this.request({
                            ...
                            session: this.session,
                            urlIds: { "id": this.id },
                            params: tslib_1.__assign({ "notify_customer": notify_customer, "tracking_info": tracking_info }, otherArgs),
                            body: body,
                            entity: this,
                        })];
                    case 1:
