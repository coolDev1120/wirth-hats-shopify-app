...
var InvalidDeliveryMethodError = /** @class */ (function (_super) {
    tslib_1.__extends(InvalidDeliveryMethodError, _super);
    function InvalidDeliveryMethodError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidDeliveryMethodError;
}(ShopifyError));
...
var InvalidWebhookError = /** @class */ (function (_super) {
    ...
    function InvalidWebhookError(_a) {
        var message = _a.message, response = _a.response;
        var _this = _super.call(this, message) || this;
        _this.response = response;
        return _this;
...
var FeatureDeprecatedError = /** @class */ (function (_super) {
    tslib_1.__extends(FeatureDeprecatedError, _super);
    function FeatureDeprecatedError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return FeatureDeprecatedError;
}(ShopifyError));
